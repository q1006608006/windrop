package top.ivan.windrop.system;
...
import static top.ivan.windrop.system.clipboard.ClipType.*;
...
public class ClipUtils {
    ...
    public static String getResourceName(ClipBean bean) {
        return ClipUtils.isFile(bean)
                ? ((FileBean) bean).getFileName()
                : ClipUtils.getClipBeanTypeName(bean);
    }
