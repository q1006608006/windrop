...
public class SystemUtils {
    ...
    public static String getSystemKey() {
        if (!StringUtils.hasLength(systemKey)) {
            String keyStr = String.join(";", SystemUtils.getPCName(), SystemUtils.getMotherboardSN(), SystemUtils.getCpuSN());
    ...
    public static byte[] encrypt(byte[] data) {
        return CryptoUtil.encrypt(data, getSystemKey());
    }

    public static byte[] decrypt(byte[] data) {
        return CryptoUtil.decrypt(data, getSystemKey());
    }
